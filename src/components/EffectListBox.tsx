...
const lists = [
  ...
  { name: "Walk Through", code: NFT_EFFECT.WALK_THROUGH},
  { name: "Sphere View", code: NFT_EFFECT.SPHERE_VIEW},
  // { name: "DNA View", code: NFT_EFFECT.DNA_VIEW},
  { name: "Pyramid View", code: NFT_EFFECT.PYRAMID_VIEW},
  { name: "Drag View", code: NFT_EFFECT.DRAG_VIEW},
];
...
const EffectListBox: FC<EffectListBoxProps> = ({
  ...
  return (
    <div
      className={`nc-EffectListBox ${className}`}
