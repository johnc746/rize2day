...
const AccountPage: FC<AccountPageProps> = ({ className = "" }) => {
  ...
  const onClickUpdate = async () => {
      console.log("onClickUpdate() 00 detailedInfo ===> ", detailedInfo)
      console.log("onClickUpdate() 00 currentUsr ===> ", currentUsr)
      const params = {
        email: emailText,
