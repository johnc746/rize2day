...
const TabDetail = (props:any) => {
      ...
      <ul className="divide-y divide-neutral-100 dark:divide-neutral-700">
        {
          ...
          >
            <div className="flex items-center" onClick={() => navigate(`/page-author/${item?.user_id?._id || ""}/${(item as any).user_id?.view_mode || 0}`)}>
      ...
      <ul className="divide-y divide-neutral-100 dark:divide-neutral-700">
        {
          ...
          >
            <div className="flex items-center" onClick={() => navigate(`/page-author/${item?.owner?._id || ""}/${item?.owner?.view_mode || 0}`)} >
              <Avatar sizeClass="h-10 w-10" radius="rounded-full" 
  ...
  const renderTabOwner = () => {
    return (
      <div className="flex items-center py-4" onClick={() => navigate(`/page-author/${(consideringNFT as any)?.owner?._id || ""}/${(consideringNFT as any).owner?.view_mode || 0}`)} >
